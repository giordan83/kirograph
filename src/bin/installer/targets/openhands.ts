...
export function installOpenHandsLate(projectRoot: string, opts: LateInstallOptions): void {
  ...
  const changed = upsertGeneratedBlock(agentsPath, OPENHANDS_BLOCK_ID, '## KiroGraph', buildAgentInstructions(buildInstructionOpts(opts, false)));
  console.log(changed
