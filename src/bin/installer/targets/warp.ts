...
export function installWarpLate(projectRoot: string, opts: LateInstallOptions): void {
  ...
  const changed = upsertGeneratedBlock(agentsPath, WARP_BLOCK_ID, '## KiroGraph', buildAgentInstructions(instructionOpts));
  console.log(changed
