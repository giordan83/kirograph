  ...
  const groups: Group[] = [
    ...
    },
    {
      ...
      commands: [
        ...
        { name: 'mem', args: '<command>', desc: 'Persistent memory (search, store, timeline, status, prune, lint, reembed)' },
        { name: 'data', args: '<command>', desc: 'Tabular data navigation (list, describe, query, aggregate, search, index, reindex)' },
