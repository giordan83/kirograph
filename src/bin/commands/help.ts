  ...
  const groups: Group[] = [
    ...
    },
    {
      ...
      commands: [
        ...
        { name: 'export',   args: '<build|start> [path]', desc: 'Export the graph as an interactive HTML visualization', opts: ['build [path]        Generate .kirograph/export/ (index.html, app.css, app.js)', 'start [path]        Generate and open in browser', '-o, --output <dir>  Custom output directory', '--include-contains  Include structural contains edges'] },
